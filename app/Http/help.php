...
/**
 * supprime les espace au debut et a la fin
 * @param $string
 * @return string
 */
...
/**
 * Recherche les clef identique dans un tableau
 * @param $array
 * @param string $value
 * @return static
 */
...
function carbon($option = nul)
{
    $date = new \Carbon\Carbon();

    if($option == 'ymd') return $date->format('Y-m-d');
    if($option == 'y') return $date->format('Y');
    if($option == 'm') return $date->format('m');
    if($option == 'd') return $date->format('d');
